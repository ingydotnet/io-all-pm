...
C<catdir>, C<catfile>, C<catpath>, C<cc>, C<chdir>, C<chomp>,
C<clear>, C<close>, C<confess>, C<content>, C<ctime>, C<curdir>,
C<dbm>, C<deep>, C<device>, C<device_id>, C<devnull>, C<dir>, C<domain>,
C<empty>, C<ext>, C<encoding>, C<eof>, C<errors>, C<file>, C<filename>,
C<fileno>, C<filepath>, C<filter>, C<fork>, C<from>, C<ftp>, C<get>,
C<getc>, C<getline>, C<getlines>, C<gid>, C<handle>, C<head>, C<http>,
C<https>, C<inode>, C<io_handle>, C<is_absolute>, C<is_dir>, C<is_dbm>,
...
C<mailer>, C<mailto>, C<mimetype>, C<mkdir>, C<mkpath>, C<mldbm>,
C<mode>, C<modes>, C<mtime>, C<name>, C<new>, C<next>, C<nlink>, C<open>,
...
Requires the L<File::MimeInfo> CPAN module.
