...
is($$file_link, $$file_target, "file link scalar-dereferences the same as the file dereferences");
is_deeply(\@$file_link, \@$file_target, "file link array-dereferences the same as the file dereferences");
...
is($$dir_link, $$dir_target, "dir link file-dereferences to same as the dir dereferences");
is_deeply(\@$dir_link, \@$dir_target, "dir link array-dereferences the same as the dir dereferences");
is_deeply(\%$dir_link, \%$dir_target, "dir link hash-dereferences the same as the dir dereferences");
